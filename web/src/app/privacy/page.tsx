...
export const metadata: Metadata = {
  title: "Privacy — Edge",
  description: "What Edge stores, what it deliberately does not, and who else sees it.",
};
...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy">
      ...
      <Section heading="Age">
        <p>Edge is not intended for anyone under 13, and we do not knowingly collect their information.</p>
      </Section>

      <Section heading="Changes">
        <p>
          If this page changes in a way that matters, the date at the top changes and we say so in the app. Continuing
          to use Edge after that means the new version applies.
        </p>
      </Section>
    </LegalPage>
  );
