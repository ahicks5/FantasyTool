...
export default function TermsPage() {
  return (
    <LegalPage title="Terms">
      <Section heading="What Edge is">
        <p>
          Edge reads a fantasy football league you already have and tells you what it would do this week: who to start,
      ...
      <Section heading="Refunds">
        <p>
          If Edge is not useful to you, ask within {LEGAL.refundDays} days of buying and we will refund it in full. No
          reasoning required.
        </p>
        <p>
      ...
      <Section heading="What Edge does not promise">
        <p>
          Projections come from third parties and are estimates. Edge re-scores them to your league&rsquo;s settings and
        ...
        <p>
          Edge is provided as is. We are not liable for lineup outcomes, league placings, missed waiver claims, trades
          you accept or decline, or anything else that follows from acting on its advice. Nothing here is financial or
          betting advice, and Edge is not a gambling service.
        </p>
      </Section>
      ...
      <Section heading="Using it fairly">
        <Bullets
          items={[
            <>Use Edge for your own leagues. Do not resell, rebrand or redistribute what it produces as a service.</>,
            <>
      ...
      <Section heading="Availability">
        <p>
          Edge is a seasonal product and is most useful during the NFL season. We aim to keep it up through the week
      ...
      <Section heading="Ending it">
        <p>
          You can stop using Edge at any time and ask us to delete your account. We can suspend access for behaviour
