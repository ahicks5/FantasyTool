...
const DESCRIPTION =
  "Take the top floor. Penthouse writes your fantasy football call sheet every week: who starts, who to claim, what to offer.";
...
export const metadata: Metadata = {
  ...
  // No explicit `images` here on purpose: the crown card is rendered by
